...
class="ui-btn-left ui-btn ui-shadow ui-btn-corner-all ui-btn-icon-notext ui-btn-up-a" href="main.php" data-icon="home" data-iconpos="notext" data-direction="reverse"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text">Home</span><span class="ui-icon ui-icon-home ui-icon-shadow">&nbsp;</span></span></a></a>
  <h1>WELCOME to 2Shoes!</h1>
<!-- <a href="logout.php" style="background:none; border:none;padding: 0px;height: 21px;"><img src="themes/images/bg_draggable_qaptcha.png" height="30" width="30" alt="" /></a>-->
</div>
